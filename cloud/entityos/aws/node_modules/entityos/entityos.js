							...
							if (_.has(rule, 'set'))
							{
								...
								{ 
									if (rule.env != undefined)
									{
										...
										{
											if (module.exports._util.isModuleAvailable('prompt-sync'))
											{
												const prompt = require('prompt-sync')();
												let promptCaption = rule.caption;
												if (rule.caption == undefined)
												{
													rule.caption = rule.set;
												}

												rule.value = prompt(rule.caption + ': ');
											}
										}
									}
								}
