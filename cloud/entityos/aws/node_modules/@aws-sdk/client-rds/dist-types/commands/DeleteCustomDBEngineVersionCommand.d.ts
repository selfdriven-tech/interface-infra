...
declare const DeleteCustomDBEngineVersionCommand_base: {
    new (input: DeleteCustomDBEngineVersionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteCustomDBEngineVersionCommandInput, DeleteCustomDBEngineVersionCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteCustomDBEngineVersionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteCustomDBEngineVersionCommandInput, DeleteCustomDBEngineVersionCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
