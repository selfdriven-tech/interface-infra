...
declare const PurchaseReservedDBInstancesOfferingCommand_base: {
    new (input: PurchaseReservedDBInstancesOfferingCommandInput): import("@smithy/smithy-client").CommandImpl<PurchaseReservedDBInstancesOfferingCommandInput, PurchaseReservedDBInstancesOfferingCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PurchaseReservedDBInstancesOfferingCommandInput): import("@smithy/smithy-client").CommandImpl<PurchaseReservedDBInstancesOfferingCommandInput, PurchaseReservedDBInstancesOfferingCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
