...
declare const CreateCustomDBEngineVersionCommand_base: {
    new (input: CreateCustomDBEngineVersionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateCustomDBEngineVersionCommandInput, CreateCustomDBEngineVersionCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateCustomDBEngineVersionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateCustomDBEngineVersionCommandInput, CreateCustomDBEngineVersionCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
