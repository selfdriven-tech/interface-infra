...
declare const CreateDBSnapshotCommand_base: {
    new (input: CreateDBSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDBSnapshotCommandInput, CreateDBSnapshotCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDBSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDBSnapshotCommandInput, CreateDBSnapshotCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
