...
declare const ModifyDBRecommendationCommand_base: {
    new (input: ModifyDBRecommendationCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyDBRecommendationCommandInput, ModifyDBRecommendationCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyDBRecommendationCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyDBRecommendationCommandInput, ModifyDBRecommendationCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
