...
declare const ResetDBClusterParameterGroupCommand_base: {
    new (input: ResetDBClusterParameterGroupCommandInput): import("@smithy/smithy-client").CommandImpl<ResetDBClusterParameterGroupCommandInput, ResetDBClusterParameterGroupCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ResetDBClusterParameterGroupCommandInput): import("@smithy/smithy-client").CommandImpl<ResetDBClusterParameterGroupCommandInput, ResetDBClusterParameterGroupCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
