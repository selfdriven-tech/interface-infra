...
declare const ModifyCustomDBEngineVersionCommand_base: {
    new (input: ModifyCustomDBEngineVersionCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyCustomDBEngineVersionCommandInput, ModifyCustomDBEngineVersionCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyCustomDBEngineVersionCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyCustomDBEngineVersionCommandInput, ModifyCustomDBEngineVersionCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
