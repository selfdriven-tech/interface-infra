...
declare const DescribeOptionGroupOptionsCommand_base: {
    new (input: DescribeOptionGroupOptionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeOptionGroupOptionsCommandInput, DescribeOptionGroupOptionsCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeOptionGroupOptionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeOptionGroupOptionsCommandInput, DescribeOptionGroupOptionsCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
