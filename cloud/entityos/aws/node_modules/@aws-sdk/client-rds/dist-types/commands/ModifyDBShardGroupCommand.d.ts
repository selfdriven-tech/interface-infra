...
declare const ModifyDBShardGroupCommand_base: {
    new (input: ModifyDBShardGroupCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyDBShardGroupCommandInput, ModifyDBShardGroupCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyDBShardGroupCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyDBShardGroupCommandInput, ModifyDBShardGroupCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
