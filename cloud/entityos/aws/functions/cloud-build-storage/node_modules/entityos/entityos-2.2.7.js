...
module.exports = 
{
	...
	send: function (options, data, callBack, callBackParam)
	{
		...
		if (_.isPlainObject(requestData))
		{
            ...
            {
				/*if (requestData.summaryFields.length == 0) { delete requestData.summaryFields}
				if (requestData.options.length == 0) { delete requestData.options}
				if (_.isEmpty(requestData.options)) { delete requestData.options}
				if (requestData.customoptions.length == 0) { delete requestData.customoptions}
				if (requestData.sorts.length == 0) { delete requestData.sorts}*/
